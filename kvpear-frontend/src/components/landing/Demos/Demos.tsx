      ...
      <div className={ccn("columns", styles.columns)}>
        ...
        <div className="column col-5 col-md-12 col-sm-12">
          <div className={styles.shot}>
            <Image src="/screenshots/screenshot-2.jpeg" alt="Screenshot of KV Pear dashboard" width={600} height={350} />
          </div>
        </div>
      </div>
      <div className={ccn("columns", styles.columns)}>
        <div className="column col-5 col-md-12 col-sm-12">
          <div className={styles.shot}>
            <Image src="/screenshots/screenshot-1.jpeg" alt="Screenshot of KV Pear dashboard" width={600} height={350} />
          </div>
        </div>
        <div className="column col-1 col-md-12 col-sm-12"></div>
        <div className="column col-6 col-md-12 col-sm-12">
